...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 10242 | 132 | The runnable binary, and the only crate that reaches everything else. |
...
As of this writing **all 23 crates are reachable and the baseline is empty**.
