...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 9368 | 118 | The runnable binary, and the only crate that reaches everything else. |
