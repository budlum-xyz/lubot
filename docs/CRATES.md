...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 7853 | 105 | The runnable binary, and the only crate that reaches everything else. |
