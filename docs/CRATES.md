...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 7776 | 105 | The runnable binary, and the only crate that reaches everything else. |
