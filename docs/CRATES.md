...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 8963 | 112 | The runnable binary, and the only crate that reaches everything else. |
