...
| crate | lines | tests | what it holds |
|---|---|---|---|
| `cli` | 9670 | 119 | The runnable binary, and the only crate that reaches everything else. |
