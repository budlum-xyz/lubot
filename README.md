...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 59 gates, each with its own self-test; the ratchet holds (447 tests, 59 gates, 0 pedantic warnings, 1715 corpus records, 98229 corpus tokens, 1 bootstrap round, 12 exam question).
