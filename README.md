...
426 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 50 gates, each with its own self-test; the ratchet holds (426 tests, 50 gates, 0 pedantic warnings, 1578 corpus records).
