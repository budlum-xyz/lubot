...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 58 gates, each with its own self-test; the ratchet holds (447 tests, 58 gates, 0 pedantic warnings, 1714 corpus records, 97861 corpus tokens, 1 bootstrap round, 12 exam question).
