...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 55 gates, each with its own self-test; the ratchet holds (447 tests, 55 gates, 0 pedantic warnings, 1711 corpus records, 96645 corpus tokens, 1 bootstrap round).
