...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 56 gates, each with its own self-test; the ratchet holds (447 tests, 56 gates, 0 pedantic warnings, 1712 corpus records, 97166 corpus tokens, 1 bootstrap round, 0 exam question).
