...
426 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 51 gates, each with its own self-test; the ratchet holds (426 tests, 51 gates, 0 pedantic warnings, 1579 corpus records).
