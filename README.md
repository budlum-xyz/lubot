...
433 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 53 gates, each with its own self-test; the ratchet holds (433 tests, 53 gates, 0 pedantic warnings, 1591 corpus records, 89547 corpus tokens).
