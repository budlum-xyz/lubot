...
426 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 49 gates, each with its own self-test; the ratchet holds (426 tests, 49 gates, 0 pedantic warnings, 1577 corpus records).
