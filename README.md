...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 57 gates, each with its own self-test; the ratchet holds (447 tests, 57 gates, 0 pedantic warnings, 1713 corpus records, 97515 corpus tokens, 1 bootstrap round, 12 exam question).
