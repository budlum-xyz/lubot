...
447 tests, `clippy -D warnings` clean, `unwrap`/`expect` denied outside tests. 54 gates, each with its own self-test; the ratchet holds (447 tests, 54 gates, 0 pedantic warnings, 1704 corpus records, 94634 corpus tokens).
